class Order:
    """Класс, представляющий заказ.
       ...
       методы :
        - add_product для пополнения списка товаров заказа -  параметр список добавляемых товаров
        - del_product для удаления товаров из списка товаров заказа - параметр список удаляемых товаров
    """ 
