...
class Discount:
    ...
    Класс, для хранения и применения скидок.
       ...
       методы :
        - add_discounts для пополнения словаря скидок параметр - словарь добавляемых скидок
        - del_discounts для удаления элементов из словаря скидок клиента
           параметр - список ключей удаляемых элементов словаря.
